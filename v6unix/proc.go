...
// PDP11 シミュレーターを使用してユーザー プログラムを実行
// カーネルは V6 カーネルの忠実なシミュレーション
// メモリ内のデータ構造やその他の単純化された前提を使用するように記述

// PDP11 ディスク、ターミナル、および他のハードウェア
// ユーザーは、シミュレートされた RK05 ディスク パックの構成方法を学ぶ代わりに、Unix プログラムがどのように動作し、
// システムを使用するのがどのようなものかに集中することができる
